 ...
 * Use the [AddEditJournalFragment.newInstance] factory method to
...
class AddEditJournalFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_add_edit_journal, container, false)
    }
